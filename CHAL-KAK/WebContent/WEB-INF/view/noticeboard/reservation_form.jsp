...
<title>form</title>
<!-- Bootstrap core CSS -->
<link href="/CHAL-KAK/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
...
<body>
	...
	// 	str = arr[0];
	%>
	<c:forEach items="${con}" var="content">
			...
			<div class="row">
				<form action="/CHAL-KAK/reservationForm.ck" method="post">
					<table class="table" style="text-align: center;">
						<thead>
							<tr>
								<th colspan="2" style="text-align: center; size: 15px">게시글
									예약</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td><input type="hidden" name="brd_seq"
									class="form-control" value="${content.brd_seq}"
							...
							<tr>
								...
								<td><input type="text" class="form-control" name="title"
									maxlength="100" readonly="readonly" value="${content.title}" /></td>
							</tr>
							<tr>
								<td>Content</td>
								<td><textarea class="form-control" name="content"
										maxlength="2048" style="height: 200px; width: 500px;"
										readonly="readonly">${content.content}</textarea></td>
							</tr>
						</tbody>
						<tbody>
							<tr>
								<td>Day</td>
								<td><input type="text" class="form-control" name="day"
									value="${content.day}" readonly="readonly" pattern="yyyy.MM.dd" /></td>
							</tr>
							<tr>
								<td>Start Time</td>
